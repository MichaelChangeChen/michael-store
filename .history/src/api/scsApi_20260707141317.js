...
const apiOrigin = 'https://ps-store-backend-uucr.onrender.com';
const apiPath = import.meta.env.VITE_API_PATH || '';
const publicPath = import.meta.env.VITE_PUBLIC_PATH || '';
const uploadPath = import.meta.env.VITE_UPLOAD_PATH || '';

const resolveBaseUrl = path => 'https://ps-store-backend-uucr.onrender.com';

const request = axios.create({ baseURL: 'https://ps-store-backend-uucr.onrender.com' });
